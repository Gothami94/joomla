...
<div class="jsn-predefine-bg-selection">
	...
	<fieldset class="jsn-url-properties" style="display:none">
	...
	<form action="index.php" id="imageForm" method="post"
		...
		<div class="button">
			<button type="button"
				onclick="JSNISImageManager.onok('<?php echo $act?>');window.parent.setTimeout('SqueezeBox.close()', 200);">
				<?php echo JText::_('Select') ?>
			</button>
			<button type="button"
				onclick="window.parent.setTimeout('SqueezeBox.close()', 200);">
