...
abstract class JModuleHelper
{
	...
	public static function getLayoutPath($module, $layout = 'default')
	{
		...
		/* Trigger onJSNTPLGetModuleLayoutPath to get overidden layout module */
		$JSNTPLfPath	= '';
		$app			= JFactory::getApplication();
		$result			= $app->triggerEvent('onJSNTPLGetModuleLayoutPath', array($module, $layout));
		...
		if ($JSNTPLfPath != '' && file_exists($JSNTPLfPath))
		{
			return $JSNTPLfPath;
		}
