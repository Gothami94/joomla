...
class JFormFieldModal_Image_For_Background extends JFormField {
	
	protected $type = 'Modal_Image_For_Background';
	...
	protected function getInput() {
		...
		return JHTML::_('select.genericlist', $files, 'jform[background_image]', 'class="inputbox" size="1"', 'value', 'text', $this->value);
	}
}