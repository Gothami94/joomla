...
class JFormFieldModal_Image_File extends JFormField {
	
	protected $type = 'Modal_Image_File';
	...
	protected function getInput() {
		...
		return JHTML::_('select.genericlist', $files, 'jform[file]', 'class="inputbox" size="1"', 'value', 'text', $this->value);
	}
}