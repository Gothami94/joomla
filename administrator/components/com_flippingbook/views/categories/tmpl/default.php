...
$canOrder = $user->authorise('core.edit.state', 'com_flippingbook');
...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_flippingbook&task=categories.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_flippingbook&view=categories');?>" method="post" name="adminForm" id="adminForm">
	<div class="row-fluid">
		...
		<table class="table table-striped" id="articleList">
			...
			foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'categories.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
					</td>
					<td>
					<?php if ($canCreate || $canEdit) { ?>
						<a href="<?php echo JRoute::_( 'index.php?option=com_flippingbook&task=category.edit&id='. $item->id ); ?>" title="<?php echo JText::_( 'COM_FLIPPINGBOOK_EDIT_CATEGORY' ); ?>">
