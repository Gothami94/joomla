 ...
 * @version $Id: plugin.php 16648 2012-10-03 10:15:24Z giangnd $
 * @license GNU/GPL v2 http://www.gnu.org/licenses/gpl-2.0.html
 */
// No direct access
defined('_JEXEC') or die('Restricted access');
$objJoomlaVersion	= new JVersion;
$jVersion			= $objJoomlaVersion->RELEASE;
if (version_compare('3.1', $jVersion, '<='))
{
	require_once JPATH_LIBRARIES . DS . 'cms' . DS . 'installer' . DS . 'adapter' . DS . 'plugin.php';
}
elseif(version_compare('3.0', $jVersion, '<=') && version_compare('3.1', $jVersion, '>'))
{
