 ...
 * @version $Id: jsn_is_archive.php 9432 2011-11-04 10:48:23Z trungnq $
 */
...
class JSNISArchive
{
	...
	{
		if ($this->options['name'] && $this->JSNISArchive)
		{
			if (JFile::write($this->options['name'], $this->JSNISArchive)) {
				return true;
			}
		}
		return false;
